...
- **Base:** [ghcr.io/ublue-os/silverblue-main:stable](https://github.com/ublue-os/main) (bootc).
...
2. **Base image** – The Containerfile uses `ghcr.io/ublue-os/silverblue-main:stable`. Change the `FROM` line if you want another base.
