...
2. **1.2** – تم: لوحة المفاتيح العربية/الإنجليزية مفعّلة.
3. **6.1 + 6.2** – تم: README.ar.md و docs/DOWNLOAD.md.

**أولوية متوسطة (تجربة مستخدم أفضل):**
4. **1.1** – جعل واجهة GNOME عربية افتراضياً عند أول تشغيل.
5. **5.2** – تم: retention-days: 14.
6. **6.3** – تم: docs/LOCALE.md.

**أولوية أقل (تحسينات إضافية):**
7. **4.2** – إصدار ديناميكي في `PRETTY_NAME`.
8. **7.1** – تم: shellcheck في build.yml.
