...
**الخلاصة:** Fedora/Bluefin يأتي مع zram مفعّلاً. التطبيقات تبقى في الذاكرة ولا تُقتل عند التبديل – مثل macOS. عند امتلاء الذاكرة، يستخدم النظام zram (ضغط في الذاكرة) بدل swap على القرص، وهذا أسرع بكثير.
...
Bluefin يستخدم tuned-ppd. للأجهزة المكتبية أو عند الرغبة بأقصى أداء:
